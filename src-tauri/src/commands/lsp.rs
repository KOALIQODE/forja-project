//! LSP commands — server discovery, installation, and document lifecycle.
//!
//! Manages a registry of known LSP servers and bridges Tauri IPC to the
//! [`LspClientManager`] infrastructure adapter.

use serde::{Deserialize, Serialize};
use tauri::{AppHandle, Emitter, State};
use std::sync::Mutex;
use crate::infrastructure::lsp::client::LspClientManager;
