//! Syntax commands — parser management, language detection, highlighting, and breadcrumbs.

use crate::infrastructure::syntax::analyzer::{CodeAnalyzer, CodeBreadcrumb};
use crate::infrastructure::syntax::dynamic_parser::{ParserMetadata, REGISTRY};
use crate::domain::models::SyntaxHighlight;
use crate::infrastructure::syntax::syntax_highlighter::SyntaxHighlighter;
