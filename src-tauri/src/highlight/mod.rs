// src-tauri/src/highlight/mod.rs
//
// Phase 3: AST → tokens for visible range.
// Uses QueryCursor on the document's stored tree-sitter AST.
// Compatible with both WASM and native parsers since it only needs the Tree + Query.
