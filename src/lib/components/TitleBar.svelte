...
>
  ...
  <div class="flex items-center pl-4">
    <div class="flex items-center gap-2.5">
      <div class="relative flex h-4 w-4 items-center justify-center">
        <div
          class="absolute h-full w-full rotate-45 border border-(--forja-ui-gradient-from,#10b981)/50 bg-(--forja-ui-gradient-from,#10b981)/10"
        ></div>
        <div
          class="z-10 h-1.5 w-1.5 rotate-45 bg-(--forja-ui-gradient-from,#10b981) shadow-[0_0_8px_rgba(16,185,129,0.6)]"
        ></div>
      </div>
      <!-- <h1
        class="flex items-center gap-1 font-bold uppercase tracking-[0.05em]"
      >
  ...
  <div class="flex items-center" style="font-size: var(--forja-program-font-size) + 4px">
    <!-- Action buttons -->
    <div class="flex items-center gap-0.5 pr-2">
      ...
      <button
        ...
        title="Help"
      >
        <BadgeQuestionMark strokeWidth={2.5} size="1.4em"/>
      </button>
    </div>
