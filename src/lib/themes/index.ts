...
export const THEMES: UITheme[] = [
  // ── Misto Dark (default) ────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      '--forja-ui-git-modified':      '#a06838',
      '--forja-ui-git-added':         '#3d8a56',
      '--forja-ui-git-renamed':       '#4a7ab5',
      '--forja-ui-git-deleted':       '#a04848',
      '--forja-ui-git-untracked':     '#5a5a66',
  ...
  // ── Misto Light ─────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      '--forja-ui-git-modified':      '#c2590a',
      '--forja-ui-git-added':         '#15803d',
      '--forja-ui-git-renamed':       '#1d4ed8',
      '--forja-ui-git-deleted':       '#b91c1c',
      '--forja-ui-git-untracked':     '#71717a',
      '--forja-ui-editor-overlay-bg': 'rgba(9,9,11,0.85)',
      '--forja-ui-editor-overlay-text':'#a1a1aa',
      '--forja-ui-editor-overlay-sep':'rgba(255,255,255,0.07)',
    },
